...
module.exports = (di) => {
    ...
    router.get('/employees', [isLoggedIn, isAdmin], (...args) =>
        employeeController.index(...args)
    );

    router.get('/employees/:id', [isLoggedIn, isEmployee], (...args) =>
        employeeController.show(...args)
    );
